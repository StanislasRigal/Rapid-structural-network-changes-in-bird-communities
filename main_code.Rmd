...
data_ts_0b <- ddply(data_ts_0, .(code_square, zonebio, habit), function(x){
  ...
  long_data <- reshape2::melt(large_data, id.vars=c("code_square","zonebio","habit","code_sp"))
  return(long_data)
})
...
habitat_sp <- reshape2::melt(habitat_sp_wide)
...
to_plot_functional_distance <- reshape2::melt(to_plot_functional_distance, id.vars="functional_distance")
...
to_plot_phylogenetic_distance <- reshape2::melt(to_plot_phylogenetic_distance, id.vars="phylogenetic_distance")
...
to_plot_specialisation_distance <- reshape2::melt(to_plot_specialisation_distance, id.vars="specialisation_distance")
...
to_plot_niche_overlap_distance <- reshape2::melt(to_plot_niche_overlap_distance, id.vars="niche_overlap_distance")
...
# do not forget to load data_interaction_possible before
...
data_rand_int <- reshape2::melt(data_rand_int, measure.vars= c(paste0("sp",i), paste0("sp",(i+100))))
...
data_rand_no_int <- reshape2::melt(data_rand_no_int, measure.vars= c(paste0("sp",(j+1000)), paste0("sp",(j+1100))))
